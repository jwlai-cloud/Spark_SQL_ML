...
def convertToBFS(line):
    ...
    # if it is start hero - e.g. Hulk, flag it immediately without processing
...
def createStartingRdd():
    inputFile = sc.textFile("file:///Users/sdljw/PycharmProjects/Spark_SQL_ML/dataset/marvel-graph.txt")
